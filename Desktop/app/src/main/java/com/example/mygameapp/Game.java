...
class Game {
    ...
    public static String AhmedLottery(int a, int b, int c)
    {
        ...
        if ((a==x && b==y && c==z))
        {
            result = "Winning Numbers: " + x + ", " + y + ", " + z + System.lineSeparator() + "Congratulations, you won the lottery!";
        }
        else
        {
            result = "Wrong, idiot" + System.lineSeparator() + "Your numbers: " + a + ", " + b + ", " + c + System.lineSeparator()+ "Winning Numbers: " + x + ", " + y + ", " + z + System.lineSeparator() + "Try Again!";
        }
        return result;
    }
